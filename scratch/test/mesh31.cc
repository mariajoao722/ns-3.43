...
std::set<uint32_t> multicastGroupNodes = {6, 9};
...
MeshTest::Run()
{
    ...
    AnimationInterface anim("mesh3.xml");
...
MeshTest::Report()
{
    ...
    out << "reports/mesh-report312.txt";
